...
public class MainActivity extends AppCompatActivity {
  ...
  private Button guardarButton, verFirmasButton;
  private EditText firmaEditText;
  private String currentPhotoPath;
  private ImageView imageView;
  private Signatures db;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    db = new Signatures(this);

    firmaEditText = findViewById(R.id.firmaTextInputEditText);
    verFirmasButton = findViewById(R.id.verFirmasButton);
    ...
    verFirmasButton.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View v) {
  ...
  private void guardarFirmasDB() {
    String description = firmaEditText.getText().toString().trim();
    ...
    if (!description.isEmpty() && !base64Image.isEmpty()) {
      ...
      Toast.makeText(this, "Firma guardada en la base de datos.", Toast.LENGTH_SHORT).show();
    } else {
  ...
  private void abrirCamara() {
    ...
    if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
      ...
      if (photoFile != null) {
        Uri photoURI = FileProvider.getUriForFile(this, "com.example.firma_sqlite.fileprovider", photoFile);
